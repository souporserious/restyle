...
The second argument to the `styled` utility also accepts a style resolver function that returns an object of styles based on the props passed to the component, referred to as _style props_. This is useful for creating components that accept dynamic styles based on props.
